...
def timeseries_analysis(params:dict, plot_limit:int=-1, color:str="blue") -> None:
    ...
    # ARIMA Model
    # train_test_ARIMA(params, features, TS, verbose, color, plot_limit=plot_limit)
    
    tsu.plot_ACF_PACF(timeseries=TS,
                      output_folder=params['timeseries_folder'],
                      series_name=features[0],
                      max_lag=params['look_ahead'],
                      verbose=verbose
                     )

    train_test_AR(params, features, TS, verbose, color, plot_limit=plot_limit)
    train_test_MA(params, features, TS, verbose, color, plot_limit=plot_limit)

    

def train_test_ARIMA(params, features, TS, verbose:bool=True, color:str="blue", plot_limit:int=-1) -> None:
    if verbose:
...
def train_test_AR(params, features, TS, verbose:bool=True, color:str="blue", plot_limit:int=-1) -> None:
    if verbose:
...
def train_test_MA(params, features, TS, verbose:bool=True, color:str="blue", plot_limit:int=-1) -> None:
    if verbose:
